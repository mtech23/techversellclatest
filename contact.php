      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="inner_hero_content">
            ...
            <div class="icon_box" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="0">
              <div class="box_icon">
                <img src="images/contact-list-icon1.webp" alt="" />
              </div>
              <p>
            ...
            <div class="icon_box" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="0">
              <div class="box_icon">
                <img src="images/contact-list-icon2.webp" alt="" />
              </div>
              <p>
            ...
            <div class="icon_box" data-aos="fade-up" data-aos-duration="1000">
              <div class="box_icon">
                <img src="images/contact-list-icon3.webp" alt="" />
              </div>
              <p>
            ...
            <h3 class="contact-page-subhead" data-aos="fade-up" data-aos-duration="2000" data-aos-offset="0"><br>
              We are trusted on
            </h3>
            <div class="techVerse_store_links" data-aos="fade-up" data-aos-duration="3000" data-aos-offset="0">
              <a href="#" class="techVerse_store_link">
                <img src="images/contact-clutch.webp" alt="" />
              </a>
              <a href="#" class="techVerse_store_link">
                <img src="images/contact-trust.webp" alt="" />
              </a>
              <a href="#" class="techVerse_store_link">
                <img src="images/contact-bbb.webp" alt="" />
              </a>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          <div class="contactPage_form" data-aos="fade-up" data-aos-offset="0" data-aos-duration="2000">
              ...
              <div class="contact_formContent">
                <form method="POST" id="leadForm" action="">
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-3 contact-formCols">
                      <div class="form-group">
                        <textarea rows="4" class="inputForm" placeholder="Please describe your project requirements" name="message"></textarea>
                      </div>
                    </div>
