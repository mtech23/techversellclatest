...
<!-- Inner Hero -->
<section class="inner_hero automotive-hero">
        ...
        <div class="col-md-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img">
              <img src="images/automotive-abt-2screens.webp" class="about-laptopImg business-devlopmentImg automotive-img1" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-lg-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img realEstate-gif">
              <img src="images/automotive-desktop.webp" class="automotive-img2" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
        ...
        <div class="col-lg-5">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img driving-2screen">
              <img src="images/driving-sec-secreen.webp" class="about-laptopImg mobileApp_devSec_img" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-lg-7">
