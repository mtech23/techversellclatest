...
<!-- Inner Hero -->
<section class="inner_hero media-hero">
        ...
        <div class="col-md-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img">
              <img src="images/media-img-1.gif" class="business-devlopmentImg media-img1" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-lg-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img realEstate-gif">
              <img src="images/media-img-2.webp" class="about-laptopImg media-img-2" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
                ...
                <div class="swiper mobileAppCarousel">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-1.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-2.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-3.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-4.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-5.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/media-portfolio-1.webp" alt="" />
                    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img ">
              <img src="images/media-img-3.webp" class="media-img3" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-lg-7">
