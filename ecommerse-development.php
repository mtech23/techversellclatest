<?php include('./layout/header.php') ?>
    ...
    <section class="techVerse_trustedPartners techVerse_trustedPartnersServices">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              <div
                class="row flex-nowrap gap-4"
                style="overflow-x: auto; gap: 15px"
              >
                <marquee>
    ...
    <section class="techVerse_webSolution">
      <img
        ...
        src="images/donate-white.png"
        alt=""
      />
      <img
        class="techVerse_webSolution_icon2 animation22"
        src="images/peramid-icon.png"
        alt=""
      />
      <div class="container">
        <div class="row">
              ...
              <div class="sec_title">
                ...
                >
                  <a href="tel:+(1) 23456-7890" class="btn_with_icon">
                    <img
                      class="btn_with_icon_img"
                      src="images/phone-icon-green.png"
                      alt=""
                    />
    ...
    <section class="techVerse_process">
      <img
        class="techVerse_process_icon1 animation22"
        src="images/peramid-left-angles.png"
        alt=""
      />
      <img
        class="techVerse_process_icon2 animation11"
        src="images/pink-capsol.png"
        alt=""
      />
      <img
        class="techVerse_process_icon3 animation33"
        src="images/orange-half-circle.png"
        alt=""
      />
      <img
        class="techVerse_process_icon4 animation22"
        src="images/peramid-left-angles.png"
        alt=""
      />
      <div class="container-fluid">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body testimonial-video">
            <iframe  
                src="https://www.youtube.com/embed/HDLbez60NbM?si=3OwKit3eSBeYEiWa" 
    ...
    <section class="techVerse_partners">
      <img
        ...
        src="images/blue-cube-large.png"
        alt=""
      />
      <img
