        ...
        <div class="col-lg-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img realEstate-gif">
              <img src="images/ecommerse-desktop-img.webp" class="about-laptopImg ecom-img2" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
                ...
                <div class="swiper mobileAppCarousel">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen1.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen2.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen3.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen4.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen5.webp" alt="" />
                    </div>
                    <div class="swiper-slide">
                      <img src="images/ecomemrse-screen1.webp" alt="" />
                    </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img ">
              <img src="images/ecommers-doubleScreens.webp" class="about-laptopImg mobileApp_devSec_img" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-lg-7">
