...
<section class="case-study-sec case-study-sec1" style="background-image: url(images/case-study-sec111-bg.webp);">
  ...
  <!--    <img src="images/case-study-sec1-bg.webp" alt="">-->
  <!--</div>-->
  <div class="width-1600">
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <!--        <img src="images/case-study-img111.webp" class="case-study-img1" />-->
        <!--    </div>-->
        <!--</div>-->
      </div>
    </div>
  ...
  <div class="width-1600">
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <!--<div class="col-md-6">-->
        <!--    <div class="casestudy-img">-->
        <!--        <img src="images/case-study-img222.webp" class="case-study-img2" />-->
        <!--    </div>-->
        <!--</div>-->
      </div>
    </div>
  ...
  <div class="width-1600">
    <div class="container-fluid">
      <div class="row align-items-center">
        ...
        <!--<div class="col-md-6">-->
        <!--    <div class="casestudy-img">-->
        <!--        <img src="images/case-study-img6.webp" class="case-study-img6" />-->
        <!--    </div>-->
        <!--</div>-->
      </div>
    </div>
