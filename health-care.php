        ...
        <div class="col-md-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img">
              <img src="images/health-care-img1.png" class="business-devlopmentImg health-care-img-1" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-lg-6">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img realEstate-gif">
              <img src="images/health-care-img2.png" class="about-laptopImg health-care-img-2" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-5">
          <div class="techVerse_about_img">
            <div class="techVerse_about_laptop_img ">
              <img src="images/health-care-img3.png" class="health-care-img-3" data-aos="fade-right" data-aos-offset="0" data-aos-duration="1000" />
            </div>
          </div>
        </div>
        <div class="col-lg-7">
